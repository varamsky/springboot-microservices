...
// For this project, we have added only integration tests here. No unit tests.
@SpringBootTest
@Testcontainers
...
class ProductServiceApplicationTests {
    ...
    static void setProperties(DynamicPropertyRegistry dynamicPropertyRegistry) {
        // this will add this property dynamically while running mongodb in the container
